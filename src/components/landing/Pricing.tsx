    ...
    <section id="preturi" className="relative bg-accent-50/30 px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-14 grid gap-6 sm:mt-16 sm:grid-cols-2">
          {/* Free tier */}
          <div className="rounded-2xl border border-secondary-200 bg-white p-8 sm:p-10 shadow-sm">
            <p className="text-base font-semibold text-secondary-500">Gratuit</p>
            <div className="mt-3 flex items-baseline gap-1">
              <span className="text-5xl font-bold tracking-tight text-secondary-900">
                0 lei
              </span>
              <span className="text-base text-secondary-400">pentru totdeauna</span>
            </div>

            <p className="mt-4 text-base text-secondary-500">
            ...
            <ul className="space-y-3.5">
              {freeFeatures.map((f) => (
                <li
                  key={f}
                  className="flex items-start gap-3 text-base text-secondary-700"
                >
                  <Check />
                  {f}
                </li>
            ...
            <a
              href="/inregistrare"
              className="mt-8 block rounded-xl border border-secondary-200 py-3.5 text-center text-base font-medium text-secondary-700 transition-colors hover:border-secondary-300 hover:text-secondary-900"
            >
          ...
          {/* Pro tier */}
          <div className="relative rounded-2xl border-2 border-secondary-900 bg-white p-8 sm:p-10 shadow-sm">
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-secondary-900 px-4 py-1.5 text-xs font-semibold text-white">
              Recomandat
            </div>

            <p className="text-base font-semibold text-secondary-900">Pro</p>
            <div className="mt-3 flex items-baseline gap-1">
              <span className="text-5xl font-bold tracking-tight text-secondary-900">
                39 lei
              </span>
              <span className="text-base text-secondary-400">/luna</span>
            </div>
            <p className="mt-1.5 text-sm text-accent-600 font-medium">
            ...
            <a
              ...
              className="mt-8 block rounded-xl bg-secondary-900 py-3.5 text-center text-base font-medium text-white transition-colors hover:bg-secondary-800"
            >
              Incepe cu Pro
            </a>
          </div>
