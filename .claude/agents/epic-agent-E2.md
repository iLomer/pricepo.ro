---
name: meto-epic-E2
description: Use to implement tasks belonging to Auth (E2). Owns to be assigned by @meto-pm. Picks tasks tagged E2 from tasks-todo.md and runs independent tasks in parallel. Reports checkpoint status to SWARM_AWARENESS.md every 3 completed tasks. Do NOT use for tasks belonging to other epics.
